...
type Identifier struct {
	Token token.Token // will be token.IDENT
	Value string
}
...
type Boolean struct {
	Token token.Token // will be token.TRUE or token.FALSE
	Value bool
}
...
type IfExpression struct {
	Token       token.Token // will be token.IF
...
type FunctionLiteral struct {
	Token      token.Token // will be token.FUNCTION
...
type IndexExpression struct {
	Token token.Token // will be token.LBRACKET
	Left  Expression
	Index Expression
}
...
type HashLiteral struct {
	Token token.Token // will be token.LBRACE
